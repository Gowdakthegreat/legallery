        ...
        <div style="padding: 2.25rem;">
          <div style="text-align: center; margin-bottom: 2rem;">
            <div class="badge badge-gov" style="margin-bottom: 0.5rem;">
              Portal do Autor • Autenticação gov.br Ouro Ativa
            </div>
            <h2 style="font-size: 1.8rem; margin-bottom: 0.3rem;">Tokenizar Obra de Arte Física</h2>
            <p style="font-size: 0.9rem; color: var(--text-secondary);">
              Cadastre seu exemplar original, gere o Contrato Ricardiano com validade jurídica e minte o token ERC-721 na Base L2.
            </p>
          </div>
          ...
          <form id="tokenize-form" style="display: flex; flex-direction: column; gap: 1.25rem;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem;">
              ...
              <div>
                <label style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-bottom: 0.35rem;">CPF do Artista (gov.br Ouro) *</label>
            ...
            <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 1.25rem;">
              <div>
                <label style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-bottom: 0.35rem;">Serial do Chip NFC NTAG 424 DNA (Inviolável) *</label>
              ...
              <div>
                <label style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-bottom: 0.35rem;">Preço de Venda em Escrow (USDC) *</label>
                <input type="number" id="tok-price" required min="100" step="50" value="3200" style="width: 100%; font-weight: 700; color: #fff;" />
              </div>
            </div>

            <!-- Box Informativo de Garantia Legal e Direito de Sequência -->
            <div style="background: rgba(212, 175, 55, 0.08); border: 1px solid var(--border-gold); padding: 1rem; border-radius: var(--radius-md); font-size: 0.8rem; color: #cbd5e1;">
              <strong style="color: var(--gold-secondary); display: block; margin-bottom: 0.25rem;">
                🛡️ Proteção do Direito de Sequência (Art. 85 da Lei 9.610/1998):
              </strong>
              O Smart Contract configurará automaticamente 5% de royalties em toda revenda secundária deste token para a sua carteira, além da geração da minuta do Contrato Ricardiano com seu certificado digital gov.br.
            </div>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 1rem; margin-top: 1rem;">
              ...
              <button type="submit" class="btn btn-gold btn-lg">
                ...
                <span>Assinar no gov.br & Mintar na Base L2</span>
              </button>
            </div>
          </form>
        </div>
